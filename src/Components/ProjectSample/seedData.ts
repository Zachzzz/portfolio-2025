...
export const projects: ProjectSampleProps[] = [
    {
        ...
        images: ["src/assets/PokemonBattleSimulator/Battle_pokemon_sim.png", "/assets/PokemonBattleSimulator/History_Pokemon_sim.png", "/assets/PokemonBattleSimulator/TeamBuilder_Pokemon_sim.png", "/assets/PokemonBattleSimulator/Index_Pokemon_sim.png"],
